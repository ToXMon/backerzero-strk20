...
use super::fixtures::{
    EXPECTED_CAMPAIGN_ID, EXPECTED_CREATOR_COMMITMENT, EXPECTED_RECEIPT_COMMITMENT,
    EXPECTED_REFUND_ID, FIXTURE_AMOUNT, FIXTURE_CHAIN_ID, FIXTURE_CONTEXT, FIXTURE_CREATOR_SECRET,
    FIXTURE_DEADLINE, FIXTURE_GOAL, FIXTURE_IDENTITY_BINDING, FIXTURE_RECEIPT_SECRET,
    FIXTURE_SEQ_NONCE, creator_address, destination_address, helper_address, token_address,
};

#[test]
fn test_fixture_campaign_id() {
    let id = BackerZeroHashing::compute_campaign_id(
        FIXTURE_CHAIN_ID, helper_address(), creator_address(), FIXTURE_GOAL, FIXTURE_DEADLINE,
    );
